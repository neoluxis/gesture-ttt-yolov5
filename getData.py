...
def get_images_from_baidu(keyword, page_num, save_dir):
    ...
    for pn in range(0, 30 * page_num, 30):
        ...
        for image_url in image_url_list:
            ...
            with open(os.path.join(save_dir, f'{keyword}_{n:04d}.jpg'), 'wb') as fp:
                fp.write(image_data)
            n = n + 1
            print(f'Get {n} images.')
...
if __name__ == '__main__':
    ...
    for k in keys:
        print(f'Getting images of {k}...')
        save_dir = f"NxData/{k}"
        get_images_from_baidu(k, page_num, save_dir)
        print(f'Get images of {k} finished.')
